...
GoはGoogleで開発されたプログラミング言語です。Goはマシン語にコンパイルされてから実行されるため、PythonやRubyなどのインタプリタ言語と比較して高速です。また、ガベージコレクションや型推論等の仕組みを持っているため、C言語よりも手軽にプログラミングすることができます。Go自体は@<href>{https://go-tour-jp.appspot.com/welcome/1,Tour of Go}で学ぶことができますので、Goに触れたことがない方はまずそちらを一通り触ってみると良いかと思います。
